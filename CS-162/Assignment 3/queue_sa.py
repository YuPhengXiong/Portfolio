...
class Queue:
    ...
    def enqueue(self, value: object) -> None:
        """
        TODO: Adds a new value to the queue.
        """
    ...
    def dequeue(self) -> object:
        """
        TODO: Removes a value from the queue.
        """
        if self.is_empty():
    ...
    def front(self) -> object:
        """
        TODO: Returns the value of in the front of the queue without removing it,
         and if the queue is empty raise an exception.
        """
        if self.is_empty():
            raise QueueException
    ...
    def _double_queue(self) -> None:
        """
        TODO: Double's the capacity of the queue.
        """
        ...
        self._sa = new_sa
        self._front = 0
        self._back = self._current_size - 1 if self._current_size > 0 else -1
